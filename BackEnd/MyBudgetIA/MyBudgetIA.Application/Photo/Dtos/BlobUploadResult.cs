namespace MyBudgetIA.Application.Photo.Dtos
{
    ...
    /// </summary>
    /// <remarks>If the upload fails, error details are provided in the ErrorMessage and ErrorCode properties.
    /// When IsSucess is <see langword="false"/>, BlobName, Etag, and LastModifiedAt may not be meaningful.</remarks>
    ...
    public sealed class BlobUploadResult(string blobName, string trackingId)
    {
        ...
        /// </summary>
        public static BlobUploadResult CreateSuccess(string fileName, string trackingId, string blobName, string etag, DateTimeOffset? lastModifiedUtc = null)
        ...
        /// </summary>
        public static BlobUploadResult CreateFailure(string fileName, string trackingId, string blobName, string errorMessage, string? errorCode = null)
            => new(blobName, trackingId)
            {
                FileName = fileName,
                TrackingId = trackingId,
